export const BACK_BUTTON = require("../../images/icon_back.png");
export const QR = require("../../images/icon_qrcode.png");
export const CAMERA = require("../../images/icon_camera.png");
export const VOUCHER = require("../../images/icon_voucher.png");
