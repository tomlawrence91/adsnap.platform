export const brandTerms = {
  ...
  'AUDI': ['Audi', 'audi', 'AUDI'],
  'AUSTIN REED': ['austin reed', 'AUSTIN,REED'],
  'AVIS': ['Avis', 'AVIS', 'avis'],
  ...
  'BURGER KING': ['Burger King', 'burger king', 'BurgerKing', 'burgerking', 'WHOPPER'],
  ...
  'CATH KIDSTON': ['Cath Kidston', 'cath kidston' 'Cath,Kidston,EST.,LONDON,1993'],
  ...
  'COAST': ['Coast', 'coast'],
  'COMET': ['Comet', 'comet'],
  'COMPTOIR LIBANAIS': ['Comptoir Libanais', 'comptoir libanais', 'COMPTOIR LIBANAIS','COMPTOIR,LIBANAIS'],
  'CORAL': ['Coral', 'coral'],
  'COS': ['Cos', 'COS', 'cos'],
